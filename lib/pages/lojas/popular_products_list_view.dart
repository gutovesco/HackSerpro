...
class PopularLojasListView extends StatefulWidget {
  ...
  @override
  _PopularLojasListViewState createState() => _PopularLojasListViewState();
}

class _PopularLojasListViewState extends State<PopularLojasListView>
          ...
          if (!snapshot.hasData) {
            ...
            return GridView(
              ...
              children: List<Widget>.generate(
                ProdutoUnitario.popularProductsList.length,
                (int index) {
                  final int count = ProdutoUnitario.popularProductsList.length;
                  ...
                  return CategoryView(
                    ...
                    category: ProdutoUnitario.popularProductsList[index],
                    animation: animation,
                    animationController: animationController,
                  );
                },
...
class CategoryView extends StatelessWidget {
  ...
  final ProdutoUnitario category;
